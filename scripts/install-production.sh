...
echo "  PostgreSQL : 127.0.0.1:${POSTGRES_PUBLISH_PORT:-5432}  (ppkp-postgres / sikerja-postgres)"
...
echo "  Redis      : 127.0.0.1:${REDIS_PUBLISH_PORT:-6379}"
echo "  MinIO      : 127.0.0.1:${MINIO_CONSOLE_PORT:-9001} (console)"
echo ""
